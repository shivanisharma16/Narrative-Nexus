export default  [
    {
        name:'Blog Title',
        desc:'An AI tool that generate blog title depends on yout blog information and data',
        category:'Blog',
    ...
    },
    {
        ...
        desc: 'AI Model to Correct your english grammer and spellings by providing the text',
    ...
    {
        name: 'Explain Code',
        desc: 'AI Model to explain programming code in any language. For example- C, C++, Java, Python',
